...
{
    public class engeneer_statesMap : EntityTypeConfiguration<engeneer_states>
    {
        public engeneer_statesMap()
        {
            // Primary Key
            this.HasKey(t => t.id);

            // Properties
            this.Property(t => t.engeneer_sid)
                .IsRequired()
                .HasMaxLength(46);
            ...
            this.ToTable("engeneer_states");
            this.Property(t => t.id).HasColumnName("id");
            this.Property(t => t.engeneer_sid).HasColumnName("engeneer_sid");
