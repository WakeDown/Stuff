...
{
    public class recruit_selections_viewMap : EntityTypeConfiguration<recruit_selections_view>
    {
        public recruit_selections_viewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.id, t.id_candidate, t.id_vacancy, t.dattim1, t.dattim2, t.enabled, t.creator_sid, t.candidate_display_name, t.candidate_male, t.state_name, t.show_next_state_btn, t.state_is_active, t.state_is_accept, t.candidate_surname, t.candidate_name, t.vacancy_position_name, t.vacancy_department_name, t.vacancy_date_create, t.vacancy_cause_name, t.vacancy_creator_name, t.state_order_num, t.state_is_cancel });
            ...
            this.Property(t => t.state_order_num)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.vacancy_author_sid)
                .HasMaxLength(46);

            // Table & Column Mappings
            this.ToTable("recruit_selections_view");
            ...
            this.Property(t => t.state_order_num).HasColumnName("state_order_num");
            this.Property(t => t.state_is_cancel).HasColumnName("state_is_cancel");
            this.Property(t => t.vacancy_author_sid).HasColumnName("vacancy_author_sid");
        }
    }
}
