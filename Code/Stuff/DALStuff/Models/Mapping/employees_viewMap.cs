...
{
    public class employees_viewMap : EntityTypeConfiguration<employees_view>
    {
        public employees_viewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.id, t.ad_sid, t.id_manager, t.surname, t.name, t.full_name, t.display_name, t.id_position, t.id_organization, t.id_emp_state, t.id_department, t.id_city, t.emp_state, t.emp_state_sys_name, t.position, t.organization, t.city, t.department, t.male, t.id_position_org, t.position_org, t.has_ad_account, t.date_create, t.is_hidden, t.newvbie_delivery });
            ...
            this.Property(t => t.is_hidden)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.dep_sys_name)
                .HasMaxLength(50);

            this.Property(t => t.pos_sys_name)
                .HasMaxLength(50);
            ...
            this.Property(t => t.dep_sys_name).HasColumnName("dep_sys_name");
            this.Property(t => t.pos_sys_name).HasColumnName("pos_sys_name");
            ...
            this.Property(t => t.is_chief).HasColumnName("is_chief");
        }
    }
}
