...
namespace DbContextStuffAutoGenerated.Models.Mapping
{
    public class requestMap : EntityTypeConfiguration<request>
    {
        public requestMap()
        {
            ...
            this.Property(t => t.sid_creator).HasColumnName("sid_creator");
            ...
            this.HasOptional(t => t.employee4)
                .WithMany(t => t.requests4)
