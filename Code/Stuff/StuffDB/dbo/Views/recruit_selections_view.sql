...
CREATE VIEW [dbo].[recruit_selections_view]
AS
SELECT        s.*
--s.id, s.id_candidate, s.id_vacancy, s.dattim1, s.dattim2, s.enabled, s.creator_sid, s.deleter_sid, s.id_state, s.state_change_date, s.state_changer_sid, s.state_descr
, c.display_name AS candidate_display_name, 
	...
	v.creator_name AS vacancy_creator_name, 
	--c.file_name AS candidate_file_name, c.file_sid AS candidate_file_sid,
	c.came_type_name as candidate_came_type_name, ct.name as came_type_name, v.id_city as vacancy_id_city,
	st.order_num as state_order_num, st.is_cancel as state_is_cancel, v.author_sid as vacancy_author_sid
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'recruit_selections_view';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'recruit_selections_view';
