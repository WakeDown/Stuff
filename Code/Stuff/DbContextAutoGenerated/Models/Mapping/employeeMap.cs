...
namespace DbContextAutoGenerated.Models.Mapping
{
    public class EmployeeMap : EntityTypeConfiguration<Employee>
    {
        ...
        {
            // Primary Key
            this.HasKey(t => new { t.id, t.ad_sid, t.id_manager, t.surname, t.name, t.full_name, t.display_name, t.id_position, t.id_organization, t.id_emp_state, t.id_department, t.id_city, t.enabled, t.dattim1, t.dattim2, t.bit, t.id_position_org, t.hAS_ad_account, t.newvbie_delivery });
            ...
            this.Property(t => t.bit).HasColumnName("bit");
